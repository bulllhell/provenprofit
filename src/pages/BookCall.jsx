...
const steps = [
  {
    ...
    desc: 'Fill the form and tell us about your brand and goals.',
  },
  {
    icon: RiMessage2Line,
    title: 'Discovery Session',
    desc: 'We talk about your brand, challenges, and what you want to achieve.',
  },
  {
    icon: RiStore2Line,
    title: 'Get Your Strategy',
    desc: 'We map out a clear plan and recommend the best service for your business.',
  },
  {
...
const socials = [
  {
    ...
    label: 'WhatsApp',
    handle: 'Quick replies, usually within 1hr',
    color: '#25D366',
  ...
  },
  {
    ...
    label: '@proven_profit_',
    handle: 'DM us on Instagram',
    color: '#E1306C',
  ...
  },
  {
    ...
    href: 'https://www.facebook.com/profile.php?id=100090118610774&mibextid=ZbWKwL',
    label: 'Facebook',
    handle: 'Follow our Facebook page',
    color: '#1877F2',
  ...
  {
    icon: SiTiktok,
    href: 'https://www.tiktok.com/@provenprofit',
    label: '@provenprofit',
    handle: 'Follow us on TikTok',
    color: '#0a0808',
    bg: 'rgba(10,8,8,0.06)',
    border: 'rgba(10,8,8,0.15)',
  },
]
    ...
    >
      ...
      <div className="flex flex-col gap-2">
        ...
        <p className="text-sm leading-relaxed max-w-sm mx-auto" style={{ color: 'var(--text-muted)' }}>
          We've received your request and will reach out within <strong style={{ color: 'var(--purple)' }}>24 hours</strong> to confirm your call time. Check your inbox and WhatsApp.
        </p>
      </div>
  ...
  return (
    <div style={{ background: 'var(--light)' }} className="min-h-screen">
      ...
      <section className="relative pt-32 sm:pt-40 pb-16 overflow-hidden">
        ...
        <div
          className="absolute top-0 right-0 w-[400px] h-[300px] rounded-full pointer-events-none"
            ...
            >
              {perks.map(({ icon: Icon, text }) => (
                <span
                  ...
                  style={{ color: 'var(--text-muted)' }}
                >
                  <Icon style={{ color: 'var(--purple)' }} className="text-sm" />
                  {text}
                </span>
              ))}
            </motion.div>
            ...
            >
              ...
              <div className="card-base flex flex-col gap-4">
                ...
                <div className="flex flex-col gap-2.5">
                  <a
                    href="tel:+2348059846912"
                    className="flex items-center gap-2.5 text-sm transition-colors duration-200 hover:text-[#7C3AED]"
                    style={{ color: 'var(--text-muted)' }}
                  >
                    <RiPhoneLine style={{ color: 'var(--purple)' }} />
                    +234 805 984 6912
                  </a>
                  <a
                    href="mailto:info@provenprofitmarketing.com"
                    className="flex items-center gap-2.5 text-sm transition-colors duration-200 hover:text-[#7C3AED]"
                    style={{ color: 'var(--text-muted)' }}
                  >
                    <RiMailLine style={{ color: 'var(--orange)' }} />
                    info@provenprofitmarketing.com
                  </a>
                  <div
                    className="flex items-center gap-2.5 text-sm"
                    style={{ color: 'var(--text-muted)' }}
                  >
                    <RiMapPinLine style={{ color: 'var(--purple)' }} />
                    Lagos, Ikeja, Nigeria
                  </div>
                </div>
                ...
                <div className="flex flex-col gap-2">
                  {socials.map(({ icon: Icon, href, label, handle, color, bg, border }) => (
                    ...
                    >
                      <div
                        className="w-9 h-9 rounded-lg flex items-center justify-center text-base flex-shrink-0 group-hover:scale-110 transition-transform duration-200"
                      ...
                      <RiArrowRightUpLine
                        className="ml-auto text-sm group-hover:translate-x-0.5 group-hover:-translate-y-0.5 transition-transform duration-200"
                        style={{ color: 'var(--light-muted)' }}
                      />
                    </a>
                  ))}
              ...
              >
                ...
                >
                  ...
                  <p className="text-white/70 text-xs mt-1">
                    Fill this in and we'll confirm your time within 24 hours.
                  </p>
                </div>
                    ...
                    {submitted ? (
                      ...
                      >
                        ...
                        <div className="flex flex-col gap-1.5">
                          ...
                          <input
                            type="text"
                            placeholder="e.g. Weekdays after 5pm WAT, or weekends"
