        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 xl:gap-20 items-center">
          ...
          >
            ...
            >
              ...
              <div>
                <div className="font-heading text-sm font-bold leading-none" style={{ color: 'var(--text)' }}>
                  $2M+
                </div>
            ...
            >
              ...
              <div
                ...
                style={{
                  background: 'linear-gradient(to top, rgba(26,16,35,0.92), transparent 55%)',
                }}
              />

              {/* Name + socials over image */}
              <div className="absolute bottom-0 left-0 right-0 p-6 z-20">
                <div className="font-heading text-2xl font-bold text-white">Adeyemo</div>
                <div className="text-sm text-orange-400 mt-1">
                  Founder & CEO, Proven Profit Marketing
                </div>
            ...
            >
              <div
                className="px-4 py-2 rounded-full font-heading text-xs font-bold text-white"
          ...
          >
            ...
            >
              ...
              />
              <p
                className="font-body text-sm sm:text-base leading-relaxed italic"
                style={{ color: 'var(--text-muted)' }}
              >
                "I started Proven Profit because I was tired of seeing
                great brands fail online not because of their products,
                but because of poor execution. Every store we build,
                every campaign we run — it's personal."
              </p>
            </div>

            {/* Bio */}
            <p
              className="text-sm sm:text-base font-body leading-relaxed mb-7"
              style={{ color: 'var(--text-muted)' }}
            >
              Proven Profit Marketing was founded with one mission —
              to help ambitious brands across the US, Canada,
              Australia and Europe build a real, profitable online
              presence. From Shopify store builds to full-scale
              social media management and brand identity, we deliver
              end-to-end digital growth strategies that move the
              needle.
            </p>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-8">
              {STATS.map(({ value, label }, i) => (
                ...
                >
                  <div
                    className="font-heading text-xl font-extrabold leading-none"
