    ...
    >
      ...
      <div className="p-5 flex flex-col flex-1">
        ...
        <button
          ...
          style={{
            background: `linear-gradient(135deg, ${color}, ${colorB})`,
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-1/4 left-0 w-80 h-80 rounded-full bg-purple-600/6 blur-[80px]" />
        <div className="absolute bottom-1/4 right-0 w-80 h-80 rounded-full bg-orange-500/6 blur-[80px]" />
      </div>
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4">
        ...
        >
          ...
          <h2
            className="font-heading text-3xl sm:text-4xl font-extrabold mt-3 mb-2"
